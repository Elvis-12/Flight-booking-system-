...
public class LoginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\HP\\OneDrive\\Documents\\NetBeansProjects\\FlightBookingSystemGUI\\src\\Flight Images\\LOGO.png")); // NOI18N
        ...
        passwordtxt.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 102, 153), 2, true));
        ...
        jLabel5.setMaximumSize(new java.awt.Dimension(71, 20));
        jLabel5.setMinimumSize(new java.awt.Dimension(71, 20));

        emailtxt.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 153), 2));
    ...
    private void SignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpActionPerformed
        ...
        SignupView sugnupView = new SignupView();
        sugnupView.show();
        dispose();
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        if (passwordtxt.getText().trim().isEmpty()) {
            ...
            login.setUsername(emailtxt.getText());
            ...
            try {
                ...
                Admin adminObj = service.addAdmin(login);
                ...
                if (adminObj != null) {
                    ...
                    String enteredOtp = JOptionPane.showInputDialog(this, "Enter OTP sent on email:", "OTP Verification", JOptionPane.PLAIN_MESSAGE);
